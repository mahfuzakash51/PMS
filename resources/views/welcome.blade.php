    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up" class="">Welcome to <span>Procurement</span></h1>
          <p data-aos="fade-up" data-aos-delay="100" class="">The official business term for activities related to purchasing goods or services<br></p>
            ...
            <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Catalog and order management</h4>
              ...
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">Vendor management</h4>
              ...
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                  ...
                  <div>
                    <h4 class="d-none d-lg-block">User-Friendly Interface</h4>
